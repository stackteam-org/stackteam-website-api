        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    <!-- Assuming you have a variable $tag for the item you're updating -->
                    <form action="{{ route('dashboard.tag.update', $tag->id) }}" method="POST">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name" id="name" class="form-control mb-2" placeholder="Product name" value="{{ old('name', $tag->name) }}" required />
                            <!--end::Input-->
                        </div>
                        ...
                        <div>
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea name="text" id="editor" class="form-control">{{ old('text', $tag->text) }}</textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('dashboard.tag.index') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
                            <!--end::Button-->
                            <!--begin::Button-->
