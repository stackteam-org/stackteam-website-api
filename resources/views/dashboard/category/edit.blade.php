                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="name" class="form-control mb-2"
                                        placeholder="نام تگ را بنویسید" value="{{ old('name', $category->name) }}" />
                                ...
                                <div>
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <textarea name="text" class="form-control mb-2" placeholder="توضیحات">{{ old('text', $category->text) }}</textarea>
                                    <!--end::Editor-->
                                    >
                                </div>
                                <!--end::Input group-->
