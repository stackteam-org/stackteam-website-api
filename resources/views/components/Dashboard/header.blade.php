    ...
    <div class="container-xxl d-flex align-items-center">
        ...
        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <a href="../../demo2/dist/index.html">
                ...
                <img alt="Logo" src="{{ asset('assets/media/logos/demo2-sticky.png') }}"
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0"
                        ...
                        <div class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route('dashboard.article.index') }}" class="menu-link py-3">
                        ...
                        <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a class="menu-link py-3" href="{{ route('dashboard.category.index') }}">
                        ...
                        <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <a href="{{ route('dashboard.tag.index') }}" class="menu-link py-3">
            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center me-lg-n2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px"
                        ...
                        data-kt-menu-placement="bottom-end">
                        <img class="h-30px w-30px rounded" src="{{ asset('assets/media/avatars/300-2.jpg') }}"
                            alt="" />
                    </div>
